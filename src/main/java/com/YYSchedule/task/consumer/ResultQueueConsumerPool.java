 ...
 */
@Component
public class ResultQueueConsumerPool
{
	@Autowired
	...
	public void startThreadPool()
	{
		...
		{
			ResultQueueConsumer resultQueueConsumerThread = new ResultQueueConsumer(config, ftpConnFactory, jmsTemplate, redisTemplate, taskBasicService, taskFileService, taskResultService, taskTimestampService, jobBasicService, resultStatusMapper,failureResultQueue);
